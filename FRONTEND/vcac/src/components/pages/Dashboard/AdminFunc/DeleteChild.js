...
const DeleteChild=()=>{
  ...
  useEffect(()=>{
    console.log('http://3.110.178.10:8080/admin/' + localStorage.getItem("childId"))
     loadChild();
  },[]);
 ...
 const loadChild = () =>{
    console.log('http://3.110.178.10:8080/admin/' + localStorage.getItem("childId"))
     axios.delete('http://3.110.178.10:8080/admin/' + localStorage.getItem("childId")).then((response)=>{
