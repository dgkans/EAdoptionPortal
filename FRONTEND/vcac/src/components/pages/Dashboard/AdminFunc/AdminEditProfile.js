...
const url = 'http://3.110.178.10:8080/admin'
...
const AdminEditProfile = () => {
  ...
  const EditProfile = () => {
    ...
    axios.put(`http://3.110.178.10:8080/admin/edit-profile`, body).then((response) => {
...
<div>
    ...
    <input type="hidden" class="form-control" onChange={(e) => {
      ...
      <input type="hidden" class="form-control" defaultValue={user.isActive} onChange={(e) => {
